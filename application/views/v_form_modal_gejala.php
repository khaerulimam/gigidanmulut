...
<div class="admin-dashone-data-table-area">
                    ...
                    <div class="sparkline8-list shadow-reset tab-pane custom-inbox-message shadow-reset active">
                        <div class="sparkline8-hd">
                            <div class="main-sparkline8-hd">
                                ...
                                <form action="<?= base_url() ?>c_admincrud/vieweditgejala/<?= $gejala->kd_gejala ?>" method="POST">
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9">
                                                <input name="bobot" max=1 step=0.1 type="number" class="form-control" value="<?=$gejala->bobot?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group-inner">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9">
                                                    <div class="login-horizental cancel-wp pull-left">
                                                        <input class="btn btn-sm btn-primary login-submit-cs" type="submit" value="Simpan" name="submit">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    </div> <?php $this->load->view('template_admin/footer'); ?>